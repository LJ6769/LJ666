...
class DeleteCommentDialog extends StatelessWidget {
  const DeleteCommentDialog({super.key, required this.scale});
  ...
  static const _message =
      'Are you sure you want to delete this comment? Once deleted, '
  ...
  static Future<bool?> show(BuildContext context) {
    ...
    return showDialog<bool>(
      ...
      builder: (context) => DeleteCommentDialog(scale: scale),
    );
  }

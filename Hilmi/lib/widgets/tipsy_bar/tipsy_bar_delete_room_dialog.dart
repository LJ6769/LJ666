...
/// 删除聊天室确认弹窗（对齐设计稿）。
class TipsyBarDeleteRoomDialog extends StatelessWidget {
  const TipsyBarDeleteRoomDialog({super.key, required this.scale});
  ...
  static const _message =
      'Are you sure you want to delete the chat room? Once deleted, '
  ...
  static Future<bool?> show(BuildContext context) {
    ...
    return showDialog<bool>(
      ...
      builder: (context) => TipsyBarDeleteRoomDialog(scale: scale),
    );
  }

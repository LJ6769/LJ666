...
import 'package:hilmi/controllers/follow_list_controller.dart';
...
class FollowListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetxScreen<FollowListController>(
      create: () => FollowListController(),
      builder: (c) => Obx(() {
        final s = MediaQuery.sizeOf(context).width / FollowListController.designWidth;
